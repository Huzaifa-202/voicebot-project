...
export default function useRealTime({
    ...
    const startSession = (languageInstruction?: string) => {
        ...
        if (languageInstruction) {
            (command.session as any).instructions = languageInstruction;
        }
    ...
    const onMessageReceived = (event: MessageEvent<any>) => {
        ...
        switch (message.type) {
            ...
            case "response.text.delta":
                onReceivedResponseTextDelta?.(message as ResponseTextDelta);
                break;
    ...
    return { startSession, addUserAudio, inputAudioBufferClear, responseCancel };
}
